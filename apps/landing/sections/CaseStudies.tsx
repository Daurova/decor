// apps/landing/sections/CaseStudies.tsx
'use client';
...
export function CaseStudies() {
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-6xl px-4 pb-12 md:pb-16 text-center">
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
          ...
          <Reveal delay={0.1}>
            ...
            >
              <div className="text-[#D4C5A9] text-lg md:text-xl font-heading drop-shadow-[0_0_20px_rgba(212,197,169,0.2)]">
                ЖК «Престиж»
              </div>
              <div className="text-white/70 text-xs md:text-sm mt-0.5">
                Бизнес-класс, 24 этажа, 180 квартир
              </div>
              <div className="text-[#D4C5A9]/50 text-xs mt-1">
                Отделка фасада, освещение, сантехника
              </div>
              <div className="text-gold/40 text-xs mt-1 italic">
                «Сдали на 2 месяца раньше срока»
              </div>
            </div>
          </Reveal>
          ...
          <Reveal delay={0.2}>
            ...
            >
              ...
              <div className="text-white/70 text-xs md:text-sm mt-0.5">
                3 этажа, современное оборудование
              </div>
              <div className="text-[#D4C5A9]/50 text-xs mt-1">
                Внутренняя отделка, освещение, мебель
              </div>
              <div className="text-gold/40 text-xs mt-1 italic">
                «Полностью оснастили под ключ за 6 недель»
              </div>
            </div>
          </Reveal>
        </div>
      ...
      >
        <span>Более 100 объектов</span>
        <span className="w-px h-3 bg-[#D4C5A9]/20" />
        <span>По всей РФ</span>
        <span className="w-px h-3 bg-[#D4C5A9]/20" />
