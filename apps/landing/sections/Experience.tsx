// apps/landing/sections/Experience.tsx
'use client';
...
export function Experience() {
  const stats = [
    { number: '8+', label: 'Лет на рынке', desc: 'С 2018 года работаем с застройщиками по всей РФ' },
    { number: '100+', label: 'Реализованных объектов', desc: 'От частных домов до ЖК бизнес-класса' },
    { number: '30+', label: 'Регионов присутствия', desc: 'От Калининграда до Владивостока' },
    { number: '50+', label: 'Партнёров-производителей', desc: 'Прямые контракты с заводами в России и Китае' },
  ];
